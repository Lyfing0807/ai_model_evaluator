...
class TestAIInsightsGenerator:
    ...
    def test_generate_insights_openai_success(
        ...
        mock_response.choices[0].message.content = (
            "AI generated insights about the model performance."
        )
    ...
    @patch("ai_eval_tool.reporting.insights.openai")
    def test_generate_insights_openai_error(
        self, mock_openai, main_config_with_ai, sample_evaluation_result
    ):
    ...
    def test_prepare_context_data(self, main_config_with_ai, sample_evaluation_result):
        ...
        generator = AIInsightsGenerator(main_config_with_ai)
        context = generator._prepare_context_data(
            sample_evaluation_result, "test-run-123"
        )
    ...
    def test_generate_insights_custom_api(
...
class TestAIInsightsIntegration:
    ...
    @patch("ai_eval_tool.reporting.insights.openai")
    def test_end_to_end_insights_generation(
        self, mock_openai, main_config_with_ai, sample_evaluation_result
    ):
        ...
        insights = generator.generate_insights(
            sample_evaluation_result, "integration-test-run"
        )
    ...
    def test_insights_with_missing_data(self, main_config_with_ai):
        ...
        minimal_result = EvaluationResult(
            metrics={"perf_mean_fps": 20.0}, extra_data={}
        )
