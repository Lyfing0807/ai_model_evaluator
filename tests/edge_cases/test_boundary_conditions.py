...
"""
    ...
    def test_csv_with_malformed_data(self, temp_workspace):
        ...
        malformed_csv.write_text("""loop_id,img_name,x,y,w,h,score
...
"""
    ...
    def test_csv_with_null_values(self, temp_workspace):
        ...
        null_csv.write_text("""loop_id,img_name,x,y,w,h,score
...
class TestEvaluatorEdgeCases:
    ...
    def test_detection_evaluator_single_image_single_loop(self):
        ...
        assert result.metrics["det_stab_mean_iou_consistency"] == 1.0  # Perfect consistency with single loop
    ...
    def test_evaluator_with_null_bboxes(self):
        ...
        null_bbox_df = pl.DataFrame({
            "image_id": ["img1", "img1"],
            "loop": [1, 2],
            "internal_bbox": [[[100.0, 100.0, 150.0, 150.0]], None],  # One null bbox
            "category_id": [0, 0],
            "score": [0.9, 0.8]
        })
...
"""
    ...
    def test_memory_optimization_with_extreme_values(self, temp_workspace):
        ...
        extreme_csv.write_text("""loop_id,img_name,x,y,w,h,score
...
"""
        ...
        assert "perf_mean_fps" in result.metrics  # Performance metrics should still work
