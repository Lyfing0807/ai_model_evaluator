...
class TestAIInsightsNetworkEdgeCases:
    ...
    def test_openai_api_connection_error(
        self, mock_openai, main_config_with_ai, sample_result
    ):
    ...
    def test_custom_api_server_error(
        self, mock_post, main_config_with_ai, sample_result
    ):
    ...
    @patch("ai_eval_tool.reporting.insights.requests.post")
    def test_custom_api_malformed_response(
        self, mock_post, main_config_with_ai, sample_result
    ):
    ...
    @patch("ai_eval_tool.reporting.insights.requests.post")
    def test_custom_api_unexpected_response_structure(
        self, mock_post, main_config_with_ai, sample_result
    ):
        ...
        insights = generator.generate_insights(
            sample_result, "unexpected_structure_test"
        )
...
class TestAIInsightsDataEdgeCases:
    ...
    def test_metrics_with_none_values(self, main_config_with_ai):
        ...
        none_result = EvaluationResult(
            metrics={"metric1": None, "metric2": 0.5, "metric3": None}, extra_data={}
        )
...
class TestAIInsightsIntegrationEdgeCases:
    ...
    def test_disabled_ai_insights_with_valid_config(
        self, main_config_with_ai, sample_result
    ):
    ...
    @patch("ai_eval_tool.reporting.insights.openai")
    def test_api_response_with_unexpected_structure(
        self, mock_openai, main_config_with_ai, sample_result
    ):
